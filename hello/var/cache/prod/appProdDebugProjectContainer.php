...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gLpBRaagIO', '', 'ONHFY9hwW5TJPSCp16JT9w', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DRvyaN-LZU', '', 'ONHFY9hwW5TJPSCp16JT9w', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('068Y0lyP69', '', 'ONHFY9hwW5TJPSCp16JT9w', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '192.168.56.101', 'port' => '32768', 'dbname' => 'symfony-hello', 'user' => 'postgres', 'password' => 'postgres', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/order');

        $k = new \Symfony\Component\Security\Http\AccessMap();
        $k->add($h, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $k->add($i, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $k->add($j, array(0 => 'ROLE_CUSTOMER'), NULL);
