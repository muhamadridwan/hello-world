...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.bundle.authorization.service' => 'getApp_Bundle_Authorization_ServiceService',
            'app.bundle.customer.management.service' => 'getApp_Bundle_Customer_Management_ServiceService',
            'app.bundle.employee.management.service' => 'getApp_Bundle_Employee_Management_ServiceService',
            'app.bundle.meal.category.management.service' => 'getApp_Bundle_Meal_Category_Management_ServiceService',
            'app.bundle.meal.management.service' => 'getApp_Bundle_Meal_Management_ServiceService',
            'app.bundle.order.management.service' => 'getApp_Bundle_Order_Management_ServiceService',
            'app.bundle.user.management.service' => 'getApp_Bundle_User_Management_ServiceService',
            'app.bundle.usergroup.management.service' => 'getApp_Bundle_Usergroup_Management_ServiceService',
    ...
    /**
     * Gets the 'app.bundle.authorization.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\AuthorizationService A AppBundle\Service\AuthorizationService instance.
     */
    protected function getApp_Bundle_Authorization_ServiceService()
    {
        return $this->services['app.bundle.authorization.service'] = new \AppBundle\Service\AuthorizationService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.bundle.customer.management.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CustomerManagementService A AppBundle\Service\CustomerManagementService instance.
     */
    protected function getApp_Bundle_Customer_Management_ServiceService()
    {
        return $this->services['app.bundle.customer.management.service'] = new \AppBundle\Service\CustomerManagementService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.bundle.employee.management.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\EmployeeManagementService A AppBundle\Service\EmployeeManagementService instance.
     */
    protected function getApp_Bundle_Employee_Management_ServiceService()
    {
        return $this->services['app.bundle.employee.management.service'] = new \AppBundle\Service\EmployeeManagementService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.bundle.meal.category.management.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\MealCategoryManagementService A AppBundle\Service\MealCategoryManagementService instance.
     */
    protected function getApp_Bundle_Meal_Category_Management_ServiceService()
    {
        return $this->services['app.bundle.meal.category.management.service'] = new \AppBundle\Service\MealCategoryManagementService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.bundle.meal.management.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\MealManagementService A AppBundle\Service\MealManagementService instance.
     */
    protected function getApp_Bundle_Meal_Management_ServiceService()
    {
        return $this->services['app.bundle.meal.management.service'] = new \AppBundle\Service\MealManagementService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.bundle.order.management.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\OrderManagementService A AppBundle\Service\OrderManagementService instance.
     */
    protected function getApp_Bundle_Order_Management_ServiceService()
    {
        return $this->services['app.bundle.order.management.service'] = new \AppBundle\Service\OrderManagementService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.bundle.user.management.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\UserManagementService A AppBundle\Service\UserManagementService instance.
     */
    protected function getApp_Bundle_User_Management_ServiceService()
    {
        return $this->services['app.bundle.user.management.service'] = new \AppBundle\Service\UserManagementService($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.bundle.usergroup.management.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\UsergroupManagementService A AppBundle\Service\UsergroupManagementService instance.
     */
    protected function getApp_Bundle_Usergroup_Management_ServiceService()
    {
        return $this->services['app.bundle.usergroup.management.service'] = new \AppBundle\Service\UsergroupManagementService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wCn2-Q6zfX', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gLpBRaagIO', '', 'J2KmgUWt6M14sEgBiymW1A', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DRvyaN-LZU', '', 'J2KmgUWt6M14sEgBiymW1A', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('068Y0lyP69', '', 'J2KmgUWt6M14sEgBiymW1A', (__DIR__.'/pools'), $a));
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 4 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 5 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, '/app/app', array())), 6 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '192.168.56.102', 'port' => '32768', 'dbname' => 'symfony-hello', 'user' => 'postgres', 'password' => 'postgres', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/app/src/AppBundle/Resources/config/doctrine' => 'AppBundle\\Entity'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppBundle\\Entity\\TUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/configuration');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration/admin');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration/user');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration/usergroup');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration/userprivilege');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration/employee');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/administration/customer');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders/order');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders/cooksTheFood');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders/servesTheFood');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders/payment');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders/confirmPayment');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders/activeOrder');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/orders/history');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/myprofile');

        $w = new \Symfony\Component\Security\Http\AccessMap();
        $w->add($h, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN'), NULL);
        $w->add($i, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $w->add($j, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $w->add($k, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $w->add($l, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $w->add($m, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN'), NULL);
        $w->add($n, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN'), NULL);
        $w->add($o, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_CUSTOMER'), NULL);
        $w->add($p, array(0 => 'ROLE_KITCHEN_ADMIN'), NULL);
        $w->add($q, array(0 => 'ROLE_KITCHEN_ADMIN'), NULL);
        $w->add($r, array(0 => 'ROLE_ADMIN'), NULL);
        $w->add($s, array(0 => 'ROLE_ADMIN'), NULL);
        $w->add($t, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN', 2 => 'ROLE_CUSTOMER', 3 => 'ROLE_KITCHEN_ADMIN'), NULL);
        $w->add($u, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN', 2 => 'ROLE_CUSTOMER', 3 => 'ROLE_KITCHEN_ADMIN'), NULL);
        $w->add($v, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN', 2 => 'ROLE_CUSTOMER', 3 => 'ROLE_KITCHEN_ADMIN'), NULL);
        ...
        $ba = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $x, 'login', false);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($w, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.our_db_provider')), 'main', $a, $c, $d), 2 => $y, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $x, 'main', $z, $aa, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $g, 'main', $ba, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '579565ba6bf3a6.51348355', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $w, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $x, 'main', $ba, NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/app/app', 'UTF-8'));
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AppBundle:TUser', 'username', NULL);
    }
