 ...
 */
class TUser extends \AppBundle\Entity\TUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TUser' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\TUser' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\TUser' . "\0" . 'isActive', '' . "\0" . 'AppBundle\\Entity\\TUser' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\TUser' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\TUser' . "\0" . 'userGroup'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TUser $proxy) {
