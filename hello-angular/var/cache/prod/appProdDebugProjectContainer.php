...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gLpBRaagIO', '', 'h1PuKnpEjvcgvrcXq08Wsg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DRvyaN-LZU', '', 'h1PuKnpEjvcgvrcXq08Wsg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('068Y0lyP69', '', 'h1PuKnpEjvcgvrcXq08Wsg', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '172.19.11.113', 'port' => '32768', 'dbname' => 'symfony-hello', 'user' => 'postgres', 'password' => 'postgres', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $v->add($h, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN'), NULL);
        $v->add($i, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $v->add($j, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $v->add($k, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $v->add($l, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $v->add($m, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN'), NULL);
        $v->add($n, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN'), NULL);
        $v->add($o, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_CUSTOMER'), NULL);
        $v->add($p, array(0 => 'ROLE_KITCHEN_ADMIN'), NULL);
        $v->add($q, array(0 => 'ROLE_KITCHEN_ADMIN'), NULL);
        $v->add($r, array(0 => 'ROLE_ADMIN'), NULL);
        $v->add($s, array(0 => 'ROLE_ADMIN'), NULL);
        $v->add($t, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN', 2 => 'ROLE_CUSTOMER', 3 => 'ROLE_KITCHEN_ADMIN'), NULL);
        $v->add($u, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPERADMIN', 2 => 'ROLE_CUSTOMER', 3 => 'ROLE_KITCHEN_ADMIN'), NULL);
        ...
        $aa = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $w, 'login', false);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($v, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.our_db_provider')), 'main', $a, $c, $d), 2 => $x, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $w, 'main', $y, $z, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $g, 'main', $aa, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57bd05d2293ba3.71141668', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $v, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $w, 'main', $aa, NULL, NULL, $a, false));
    }
